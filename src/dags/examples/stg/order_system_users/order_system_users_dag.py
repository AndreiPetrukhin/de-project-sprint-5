...
from examples.stg.mongo_loader import DataLoader  # Adjusted import
...
def sprint5_example_stg_order_system_users():
    ...
    def load_data():
        ...
        data_loader.run_copy("users", query, param_template)

    data_loader_task = load_data()

    # Set the execution order (only one task in this case)
    data_loader_task


order_stg_dag = sprint5_example_stg_order_system_users()